...
def main(args):
    ...
    axs[1].legend()
    axs[1].set_ylabel('Error (SPU)')
    axs[2].plot(symmetric_test_history['time'], symmetric_test_history['drum_1'], label='Symmetric-RL drum 1')
    axs[2].plot(symmetric_test_history['time'], symmetric_test_history['drum_2'], label='Symmetric-RL drum 2')
    axs[2].plot(symmetric_test_history['time'], symmetric_test_history['drum_3'], label='Symmetric-RL drum 3')
    axs[2].plot(symmetric_test_history['time'], symmetric_test_history['drum_4'], label='Symmetric-RL drum 4')    
    axs[2].plot(symmetric_test_history['time'], symmetric_test_history['drum_5'], label='Symmetric-RL drum 5')
    axs[2].plot(symmetric_test_history['time'], symmetric_test_history['drum_6'], label='Symmetric-RL drum 6')
    axs[2].plot(symmetric_test_history['time'], symmetric_test_history['drum_7'], label='Symmetric-RL drum 7')
    axs[2].plot(symmetric_test_history['time'], symmetric_test_history['drum_8'], label='Symmetric-RL drum 8')
    axs[2].legend()
